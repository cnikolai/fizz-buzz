 ...
 * single integer.  This allows for direct unit testing.
 */
public class FizzBuzz {

  /**
   * Computes and returns the {@link String} FizzBuzz value for a specified non-negative integer.
   * Return value will be "Fizz", "Buzz", or "FizzBuzz", or the string representation of {@code
   * value} depending on whether {@code value} is divisible by 3,5,15 or none of the above.
   *
